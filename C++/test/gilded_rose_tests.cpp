...
TEST_F(GildedRoseConjuredMana, BeforeSellDateAtZeroQuality)
{
    GildedRose gilded_rose{name, 5, 0};
    gilded_rose.tick();
...
TEST_F(GildedRoseConjuredMana, OnSellDate)
{
    GildedRose gilded_rose{name, 0, 10};
    gilded_rose.tick();
...
TEST_F(GildedRoseConjuredMana, OnSellDateAtZeroQuality)
{
...
TEST_F(GildedRoseConjuredMana, AfterSellDate)
{
    GildedRose gilded_rose{name, -10, 10};
    gilded_rose.tick();
